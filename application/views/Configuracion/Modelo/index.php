                    ...
                    <div class="btn-toolbar justify-content-between mr-2" role="toolbar" aria-label="Toolbar with button groups">
                        <div class="btn-group mb-2" role="group" aria-label="First group">
                            <div class="page-title">
                                <h3 class="page-title textocambio">Modelo</h3>              
                            </div>                            
                        </div>
                        <div class="input-group mb-2" >
                            <div class="toolbar" id="boton_list">
                                <button type="button" class="btn btn-primary mb-2 mr-2" title="Registrar" data-toggle="modal" data-target="#ModalRegistro" ModalRegistro="<?= site_url('Cochera/Modal_Modelo') ?>" >
                ...
                <div class="widget-content widget-content-area br-6">
                    <div class="table-responsive mb-4 mt-4">
                        <table id="zero-config" class="table dt-table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    <th width="45%">Marca</th>
                                    <th width="45%">Modelo</th>
                                    <th class="no-content dt-no-sorting">Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach($list_modelo as $list){?> 
                                <tr>
                                    <td><?php echo $list['nom_marca'] ?></td>
                                    <td><?php echo $list['nom_modelo'] ?></td>
                                    <td>
                                        <a href="javascript:void(0);"  title="Editar" data-toggle="modal" data-target="#ModalUpdate" ModalUpdate="<?= site_url('Cochera/Modal_Update_Modelo') ?>/<?php echo $list["id_modelo"]; ?>" >
                                        ...
                                        <a title="Eliminar" onclick="Delete_Modelo('<?php echo $list['id_modelo']; ?>')" id="delete" role="button">
