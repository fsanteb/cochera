                    ...
                    <div class="widget-content widget-content-area">
                        <div class="d-flex justify-content-between">
                            ...
                            <?php if($get_id[0]['flag']==1){?>
                                ...
                                <?php }elseif($datos_porcentaje==100 && $get_id[0]['flag']==0){?>
                                <span class="mt-2 badge badge-warning">Datos Pendiente de Aprobación</span><?php }
                                elseif($datos_porcentaje==100 && $get_id[0]['flag']==2){?>
                                    <span class="mt-2 badge badge-danger">Datos Pendiente de Corrección</span><?php }?>
                            
                            
                            <a href="<?= site_url('Cochera/Perfil') ?>/<?php echo $get_id[0]["id_usuario"]; ?>" class="mt-2 edit-profile"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg></a>
                        </div>
                        <div class="text-center user-info">
                            <img style="width:90px;height:90px"src="<?php if($get_id[0]['foto']!=""){echo $get_id[0]['foto'];}else{echo base_url()."template/assets/img/90x90.jpg";}?>" alt="avatar">
                            <p class=""><?php echo $get_id[0]['usuario_nombres']." ".$get_id[0]['usuario_apater'] ?></p>
                            ...
                            <div class="progress br-30">
                                <div class="progress-bar bg-primary" role="progressbar" style="width:<?php echo $datos_porcentaje."%"; ?>" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
                                    <div class="progress-title"><span></span>
                                        <span><?php echo $datos_porcentaje."%"; ?></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="user-info-list">
                            ...
                            <div class="">
                                <ul class="contacts-block list-unstyled">
                                    ...
                                    <li class="contacts-block__item">
                                        <a href="mailto:<?php echo $get_id[0]['emailp']?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg><?php echo $get_id[0]['emailp']?></a>
                                    </li>
                                    <li class="contacts-block__item">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-phone"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg><?php echo $get_id[0]['num_celp'] ?>
                                    </li>
                                    <!--<li class="contacts-block__item">
