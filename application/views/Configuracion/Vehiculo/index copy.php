...
?>
<?php $this->load->view('Cliente_Admin/header'); ?>
<?php $this->load->view('Cliente_Admin/nav'); ?>
            ...
            <div class="btn-toolbar justify-content-between mr-2" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group mb-2" role="group" aria-label="First group">
                    <div class="page-title">
                        <h3 class="page-title textocambio">Vehículos</h3>              
                    </div>
                </div>
                <div class="input-group mb-2" style="display: flex;justify-content: center;align-content: center;" >
                    <div class="toolbar" style="height: 37px;" id="boton_list">
                        <button type="button" class="btn btn-primary mb-2 mr-2" title="Registrar" data-toggle="modal" data-target="#ModalRegistro" ModalRegistro="<?= site_url('Administrador/Modal_Vehiculo') ?>" >
...
<script>
    $(document).ready(function() {
        ...
        $("#aconfiguracion").attr('aria-expanded','true');
        $("#hconfiguracion").addClass('show');
        $("#lvehiculo").attr('aria-expanded','true');
        $("#avehiculo").addClass('show');
        $("#lrvehiculov").addClass('active');
    });
</script>   
<?php $this->load->view('Cliente_Admin/validaciones'); ?>
<?php $this->load->view('Cliente_Admin/footer'); ?>