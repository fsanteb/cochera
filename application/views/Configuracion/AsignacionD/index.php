                    ...
                    <div class="table-responsive mb-4 mt-4">
                        <table id="zero-config" class="table dt-table-hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $list['chofer'] ?></td>
                                    <td><?php echo $list['placa'] ?></td>
                                    <td>
                                        <a href="javascript:void(0);"  title="Editar" data-toggle="modal" data-target="#ModalUpdate" ModalUpdate="<?= site_url('Cochera/Modal_Update_Marca') ?>/<?php echo $list["id_asignacion"]; ?>" >
                                        ...
                                        <a title="Eliminar" onclick="Delete_Marca('<?php echo $list['id_asignacion']; ?>')" id="delete" role="button">
