                    ...
                    <div class="table-responsive mb-4 mt-4">
                        <table id="zero-config" class="table dt-table-hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $list['cod_marca'] ?></td>
                                    <td><?php echo $list['nom_marca'] ?></td>
                                    <td>
                                        <a href="javascript:void(0);"  title="Editar" data-toggle="modal" data-target="#ModalUpdate" ModalUpdate="<?= site_url('Cochera/Modal_Update_Marca') ?>/<?php echo $list["id_marca"]; ?>" >
                                        ...
                                        <a title="Eliminar" onclick="Delete_Marca('<?php echo $list['id_marca']; ?>')" id="delete" role="button">
