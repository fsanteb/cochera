                ...
                <div class="widget-content widget-content-area br-6">
                    <div class="table-responsive mb-4 mt-4">
                        <table id="zero-config" class="table dt-table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    <th width="45%">Dueño</th>
                                    <th width="45%">Vehículo</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $list['dueno'] ?></td>
                                    <td><?php echo $list['placa'] ?></td>
                                    <td>
                                        <a href="javascript:void(0);"  title="Editar" data-toggle="modal" data-target="#ModalUpdate" ModalUpdate="<?= site_url('Cochera/Modal_Update_AsignacionD') ?>/<?php echo $list["id_asignacion"]; ?>" >
                                        ...
                                        <a title="Eliminar" onclick="Delete_Asignacion_dueno('<?php echo $list['id_asignacion']; ?>')" id="delete" role="button">
