...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="compactSidebar">
        <ul class="menu-categories">
            ...
            <li class="menu" id="lioperaciones">
                <a href="#operaciones" data-active="false" class="menu-toggle">
                    <div class="base-menu">
                        <div class="base-icons">
    ...
    <div id="compact_submenuSidebar" class="submenu-sidebar">
        ...
        <div class="submenu" id="configuracion">
            <ul class="submenu-list" data-parent-element="#configuracion"> 
                <li id="tvehiculo">
                    <a href="<?= site_url('Cochera/Tipo_Vehiculo') ?>">
                ...
                <li id="marca">
                    <a href="<?= site_url('Cochera/Marca') ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-tag"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"></path><line x1="7" y1="7" x2="7.01" y2="7"></line></svg>
                    Marca</a>
                </li>
                <li id="modelo">
                    <a href="<?= site_url('Cochera/Modelo') ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
                    Modelo</a>
                </li>
                <li id="color">
                    <a href="<?= site_url('Cochera/Color') ?>">
                ...
                <li id="dueno">
                    <a href="<?= site_url('Cochera/Dueno') ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                    Dueños</a>
                </li>
                <li id="vehiculo">
                    <a href="<?= site_url('Cochera/Vehiculo') ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-truck"><rect x="1" y="3" width="15" height="13"></rect><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"></polygon><circle cx="5.5" cy="18.5" r="2.5"></circle><circle cx="18.5" cy="18.5" r="2.5"></circle></svg>
                    Vehículos</a>
                </li>
                <li id="asigdueno">
                    <a href="<?= site_url('Cochera/AsignacionD') ?>" title="Asignación de Dueño">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user-check"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><polyline points="17 11 19 13 23 9"></polyline></svg>
                    Asignación de Dueño</a>
                </li>
                <li id="costo">
                    <a href="<?= site_url('Cochera/Costo') ?>" title="Costo">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user-check"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><polyline points="17 11 19 13 23 9"></polyline></svg>
                    Costo</a>
                </li>
            </ul>
        ...
        <?php }?>
        <?php if($sesion['id_nivel']==1){?>
        <div class="submenu" id="operaciones">
            <ul class="submenu-list" data-parent-element="#operaciones"> 
                <li id="operaciones_mod">
                    <a href="<?= site_url('Cochera/Operaciones') ?>"> <span class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg></span> Operaciones </a>
                </li>
            </ul>
        </div>
        <?php }?>
